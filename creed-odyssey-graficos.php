	...
	<body>
		...
		<div class="bloco">
			...
			<div class="row">
				...
				<form class="borderBoxes tela efeitoTela" action="creed-odyssey-low.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="Low">
				</form>	
				

				<form class="borderBoxes tela efeitoTela" action="creed-odyssey-medium.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="Medium">
				</form>	
				
                <form class="borderBoxes tela efeitoTela" action="creed-odyssey-high.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="High">
				</form>					

				<form class="borderBoxes tela efeitoTela" action="creed-odyssey-ultra.php" method="POST">			
