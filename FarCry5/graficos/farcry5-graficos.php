	...
	<body>
		...
		<div class="bloco">
			...
			<div class="row">
				...
				<form class="borderBoxes tela efeitoTela" action="\FarCry5\graficos\low/farcry5-low.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="Low">
				</form>	
				

				<form class="borderBoxes tela efeitoTela" action="\FarCry5\graficos\medium/farcry5-medium.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="Medium">
				</form>	
				
                <form class="borderBoxes tela efeitoTela" action="\FarCry5\graficos\high/farcry5-high.php" method="POST">			
				<input class="btn btn-default" id="buscar" type="submit" name="Visualizar" value="High">
				</form>					

				<form class="borderBoxes tela efeitoTela" action="\FarCry5\graficos\ultra/farcry5-ultra.php" method="POST">			
